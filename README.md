...
```
## תמונה בפופאפ
לדוגמה, כך כותבים במרקדאון תמונה שתפתח בפופאפ:
```
![צילום מסך של המערכת](image.png)
```
וכך כותבים תמונה שלא תיפתח:
```
![הלוגו שלנו [רגיל]](image.png)
(המערכת חכמה מספיק כדי להעלים את המילה "[רגיל]" מאחורי הקלעים כדי שהיא לא תוצג למשתמש).
```
