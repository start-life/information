...
💡 זה לא חובה אבל לקבלת תוצאות טובות ומרשימות יותר עדיף לפרט כמה שיותר כשיותר, **לקבל תוצאות מרשימות באופן אוטומטי תוגלו להשתמש ב"מצב AI"**  
**❌ לא טוב**
\`\`\`bash
...
תוכלו לקרא על זה כאן guide#שימוש-במודל-תמונה-image-2
